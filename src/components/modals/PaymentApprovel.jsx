...
function PaymentApprovel({ open, handleClose, setOpen, jobId }) {
  ...
  const handleOnClickApprovePayment = () => {
    ...
    const apiCallUpdatePaymentApproved = PromoterCampaignService.updatePaymentApproved(
              ...
              <Stack spacing={2} sx={{ px: 3, py: 2 }}>
                ...
                <Stack direction="row">
                  ...
                  <Typography variant="body2">
                    ...
                    {jobDetails && (jobDetails.promoterCampaign.paymentApproved === true) ? "Approved" : "Not approved yet"}
                  </Typography>
                </Stack>

                <Stack spacing={1} direction="row">
                  <Button variant="contained" color="secondary">Declined</Button>
                  <Button variant="contained" onClick={handleOnClickApprovePayment}>Approved</Button>
                </Stack>
